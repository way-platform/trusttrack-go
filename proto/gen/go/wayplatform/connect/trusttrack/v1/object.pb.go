...
type Object struct {
	...
	xxx_hidden_LastPosition  *Position              `protobuf:"bytes,5,opt,name=last_position,json=lastPosition"`
...
func (x *Object) GetLastPosition() *Position {
	if x != nil {
		return x.xxx_hidden_LastPosition
	}
	return nil
}
...
func (x *Object) SetLastPosition(v *Position) {
	x.xxx_hidden_LastPosition = v
}
...
func (x *Object) HasLastPosition() bool {
	if x == nil {
		return false
	}
	return x.xxx_hidden_LastPosition != nil
}
...
func (x *Object) ClearLastPosition() {
	x.xxx_hidden_LastPosition = nil
}
...
func (b0 Object_builder) Build() *Object {
	...
	x.xxx_hidden_LastPosition = b.LastPosition
	return m0
}
...
const file_wayplatform_connect_trusttrack_v1_object_proto_rawDesc = "" +
	...
	"\rlast_position\x18\x05 \x01(\v2+.wayplatform.connect.trusttrack.v1.PositionR\flastPositionB\xbe\x02\n" +
...
var file_wayplatform_connect_trusttrack_v1_object_proto_goTypes = []any{
	...
	(*Position)(nil),      // 2: wayplatform.connect.trusttrack.v1.Position
}
var file_wayplatform_connect_trusttrack_v1_object_proto_depIdxs = []int32{
	...
	2, // 1: wayplatform.connect.trusttrack.v1.Object.last_position:type_name -> wayplatform.connect.trusttrack.v1.Position
